...
```{code-cell} ipython3
import os, sys, yaml
SOFTWARE_DIR = "/sdf/group/neutrino/koh0207/lartpc_mlreco3d/" # YOUR PATH TO LARTPC_MLRECO3D
...
```{code-cell} ipython3
cfg_file = '/sdf/group/neutrino/koh0207/laura_weights.cfg' # YOUR PATH TO THE CONFIG FILE
...
```
loader_factory(cfg, event_list=[0, 1, 2, ...]
```
...
We can perform one forawrd iteration of the chain as follows:
